        ...
        <div class="banner-image">
            <div class="container">
                <div class="content" data-aos="fade-right">
                    ...
                    <p style="text-align: justify; text-shadow: -1px -1px 1px #333, 1px -1px 1px #333, -1px 1px 1px #333, 1px 1px 1px #333;">¡Hola! Gracias por visitarnos, Acacias-Gyms es un portal web que brinda información de varios gimnasios (SPINNING FORMA,DINAMIC CENTER,SAINT HORDE ACACIAS) y los principales parques del municipio de Acacías-Meta, en estos podrás encontrar en los diferentes gimnasios información muy importante de estos como una galería, una sección para comentar y puntuar estos; del mismo modo con los entrenadores. Encontraras una sección de noticias sobre salud y bienestar y si tienes alguna duda, queja, sugerencia o quieres que tu gimnasio aparezca en nuestro portal web, podrás hacerlo a partir del formulario de contacto que encontraras en la parte superior en la sección llamada del mismo modo. Esperamos que te sirva nuestro portal web.</p>
                    <br>
